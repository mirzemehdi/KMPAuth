...
let package = Package(
  ...
  dependencies: [
    .package(path: "subpackages/_backends_firebase_kmpauth-firebase"),
    .package(path: "subpackages/_backends_firebase_kmpauth_firebase"),
    .package(path: "subpackages/_deprecated_kmpauth-firebase-facebook"),
    .package(path: "subpackages/_deprecated_kmpauth-firebase-google"),
  ...
  targets: [
    .target(
      name: "KotlinMultiplatformLinkedPackage",
      dependencies: [
        .product(name: "_backends_firebase_kmpauth-firebase", package: "_backends_firebase_kmpauth-firebase"),
        .product(name: "_backends_firebase_kmpauth_firebase", package: "_backends_firebase_kmpauth_firebase"),
        .product(name: "_deprecated_kmpauth-firebase-facebook", package: "_deprecated_kmpauth-firebase-facebook"),
        .product(name: "_deprecated_kmpauth-firebase-google", package: "_deprecated_kmpauth-firebase-google"),
